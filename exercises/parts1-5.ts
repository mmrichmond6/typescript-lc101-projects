...
// console.log(`The spacecraft, ${spacecraftName}, will take ${daysToMars} days to get to Mars.`);
...
// console.log(`The spacecraft, ${spacecraftName}, will take ${getDaysToLocation(kilometersToTheMoon)} days to get to Mars.`);
...
// console.log(`The spacecraft, ${spaceShuttle.name}, will take ${spaceShuttle.getDaysToLocation(kilometersToTheMoon)} days to get to Mars.`);
